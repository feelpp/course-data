...
The bilingual English--French glossary supports entry terminology while keeping all learning and assessment instructions in English. Mathematics uses AsciiDoc `stem` with a repository-pinned, local KaTeX runtime and is interpreted in prose near each expression.
